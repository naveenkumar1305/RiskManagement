...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "riskmanagement/risksmanagement/test/integration/FirstJourney",
    "riskmanagement/risksmanagement/test/integration/RisksListJourney",
    "riskmanagement/risksmanagement/test/integration/RisksObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
